...
export class SidebarComponent {
  menuItems: MenuItem[] = [
    // { title: 'Accueil', link: 'accueil.html' },
    // { title: 'Tableau de bord', link: 'tableau-bord' },
    // ... Ajoutez vos autres éléments de menu ici ...
    {
      title: 'Paramètres',
      icon: `
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
              d="M11.9999 14.3466C13.2959 14.3466 14.3465 13.296 14.3465 12C14.3465 10.704 13.2959 9.65344 11.9999 9.65344C10.7039 9.65344 9.65332 10.704 9.65332 12C9.65332 13.296 10.7039 14.3466 11.9999 14.3466Z"
    ...
    // ... Ajoutez d'autres éléments de menu avec leurs sous-menus ici ...
  ];
